        ...
        <div class="relative z-10 flex-1 p-6 max-w-[1400px] mx-auto w-full space-y-8">
            <div class="flex items-end justify-between border-b border-upsilon-magenta/20 pb-4">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <button 
                        @click="handlePurge"
                        :disabled="isPurging"
                        class="px-4 py-2 bg-red-900/20 border border-red-500/30 text-red-500 font-mono text-ui-sm uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all disabled:opacity-50"
                    >
            ...
            <div class="bg-black/40 border border-upsilon-steel/20 overflow-hidden">
                <table class="w-full text-left font-mono text-ui-sm">
                    <thead class="bg-upsilon-steel/10 text-upsilon-cyan uppercase tracking-widest text-ui-xs">
                        <tr>
                    ...
                    <tbody class="divide-y divide-upsilon-steel/10">
                        ...
                        >
                            <td class="px-4 py-4 font-bold text-white text-ui-sm uppercase">{{ match.id.substring(0, 8) }}...</td>
                            <td class="px-4 py-4 text-upsilon-steel uppercase">{{ match.game_mode }}</td>
                            <td class="px-4 py-4">
                                <div class="flex flex-wrap gap-1">
                                    <span v-for="p in match.participants" :key="p.id" 
                                          class="px-2 py-0.5 bg-upsilon-magenta/10 border border-upsilon-magenta/20 text-ui-xs text-upsilon-magenta uppercase"
                                    >
