...
class UpsilonEntityResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $isAutoGen = (bool) ($this->resource->auto_gen ?? false);
        ...
        if ($isAutoGen) {
            // Stats and skills are generated by the Go engine; only send archetype hints.
            $base['auto_gen'] = true;
            $base['archetype'] = $this->resource->archetype;
            if (isset($this->resource->grade)) {
                $base['grade'] = $this->resource->grade;
            }
        } else {
            // Fully-specified human character: send concrete stats, no auto_gen keys.
            $base['hp'] = $this->hp;
            $base['max_hp'] = $this->hp;
            $base['attack'] = $this->attack;
            $base['defense'] = $this->defense;
            $base['move'] = $this->movement;
            $base['max_move'] = $this->movement;
        }
