    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="mt-1 flex gap-4">
                <span class="font-mono text-ui-xs text-upsilon-steel uppercase">
                    QTY: {{ item.quantity }}
                </span>
                <span v-if="item.equipped_on" class="font-mono text-ui-xs text-upsilon-lime uppercase">
                    LINKED → {{ item.equipped_on.name }}
                </span>
                <span v-else class="font-mono text-ui-xs text-upsilon-steel/50 uppercase">
                    UNLINKED
                </span>
            </div>
        </div>
        ...
        <!-- Properties -->
        <div>
            <div class="text-ui-xs font-mono text-upsilon-steel uppercase tracking-[0.4em] mb-3">
                STAT MODIFIERS
            </div>
            ...
            <div v-else class="text-ui-xs font-mono text-upsilon-steel/50 uppercase">
                No modifiers.
            </div>
        </div>
        ...
        <div class="border-t border-upsilon-steel/20 pt-4">
            <div class="text-ui-xs font-mono text-upsilon-steel uppercase tracking-[0.4em] mb-2">
                ACQUISITION LOG
            </div>
            <div class="font-mono text-ui-xs text-upsilon-steel/60 uppercase">
