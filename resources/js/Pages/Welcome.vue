    ...
    <div class="relative min-h-screen bg-upsilon-void overflow-hidden flex flex-col font-sans selection:bg-upsilon-cyan selection:text-upsilon-void">
        ...
        <div class="flex-1 relative overflow-hidden flex items-center justify-center">
            ...
            <div class="absolute top-0 left-0 w-full h-full border-[20px] border-upsilon-gunmetal/50 pointer-events-none">
                <div class="absolute top-0 left-0 w-10 h-10 border-t-2 border-l-2 border-upsilon-cyan"></div>
                <div class="absolute top-0 right-0 w-10 h-10 border-t-2 border-r-2 border-upsilon-cyan"></div>
                <div class="absolute bottom-0 left-0 w-10 h-10 border-b-2 border-l-2 border-upsilon-cyan"></div>
                <div class="absolute bottom-0 right-0 w-10 h-10 border-b-2 border-r-2 border-upsilon-cyan"></div>
            </div>
